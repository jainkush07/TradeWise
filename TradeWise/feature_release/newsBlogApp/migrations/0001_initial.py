    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateOfNews', models.DateField(blank=True, null=True)),
                ('timeOfNews', models.TimeField(blank=True, null=True)),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='authorBN', to=settings.AUTH_USER_MODEL)),
            ],
            options={
