...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('newsBlogApp', '0003_blogwebnewslistingdm'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsBlog', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='videoBlogNHDM', to='newsBlogApp.blognews')),
            ],
        ),
    ]
